...
import { inpat } from '../../model/inpatmod';
import { Rooms } from '../../model/rooms';
import { AuthService } from '../../service/auth.service';
import { FetchingemailService } from '../../service/fetchingemail.service';
import { InpatservService } from '../../service/inpatserv.service';
import { PersonalDetailsService } from '../../service/personal-details.service';
import { RoomServicesService } from '../../service/room-services.service';
...
export class InPatientComponent implements OnInit {
  ...
  foValidation(): boolean {
    ...
    if (!this.validpincode(this.inpatient.ippincode)) {
      alert('Please provide a 5 digit pincode');
      return false;
    }
